...
- [x] **SHA-256 для множественных блоков** — исправлено!

### Предупреждения компиляции
- [x] Все предупреждения исправлены ✅
...
**Версия:** 1.1.0 (релиз)
**Статус:**
- ✅ v1.1.0 выпущен - все тесты проходят, сборка без предупреждений
