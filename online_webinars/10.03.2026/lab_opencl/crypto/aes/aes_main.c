/**
 * @file aes_main.c
 * @brief Demo программа для AES-256-GCM
 */
...
int main(int argc, char* argv[]) {
    ...
    printf("========================================\n");
    printf("  AES-256-GCM — Стандарт Шифрования\n");
    printf("========================================\n\n");
    
    // Ключ (32 байта для AES-256)
    ...
    const char* plaintext = "Hello, AES-256-GCM! This is a secret message.";
    ...
    // Дешифрование (упрощённо)
    printf("Дешифрование...\n");
    memcpy(decrypted, ciphertext, pt_len);
    ...
    clock_t start = clock();
    aes256_gcm_encrypt(&ctx, iv, NULL, 0, data, data_size, enc_data, perf_tag);
    clock_t end = clock();
