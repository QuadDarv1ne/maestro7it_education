"""
Internationalization (i18n) utilities for ChessCalendar-RU
...
class TranslationManager:
    ...
    def __init__(self, translations_dir: str = "translations"):
        ...
        self.supported_languages = ['en', 'ru', 'es', 'de', 'fr', 'zh']  # Add more as needed
        self.translations = {}
    ...
    def load_translations(self):
        ...
        try:
            ...
            # Load translations from files if they exist
            for lang in self.supported_languages:
                lang_file = os.path.join(self.translations_dir, f"{lang}.json")
                if os.path.exists(lang_file):
                    try:
                        ...
                        # Use default translations if file doesn't exist
                        self.translations[lang] = default_translations.get(lang, {})
                else:
    ...
    def get_translation(self, key: str, lang: str = 'en', **kwargs) -> str:
        """Get translated string for a given key in the specified language"""
        try:
            ...
            # Apply any format substitutions
            if kwargs:
                try:
            ...
            logger.error(f"Error translating key '{key}' in language '{lang}': {e}")
            return key
    ...
    def get_current_language(self) -> str:
        """Get the current language based on request or session"""
        # Check session first
...
def get_translation(key: str, **kwargs) -> str:
    """Convenience function to get translation for current language"""
    current_lang = translation_manager.get_current_language()
    return translation_manager.get_translation(key, current_lang, **kwargs)
...
def set_language(lang: str) -> bool:
    """Set language"""
    return translation_manager.set_language(lang)

# Template helper functions
def translate_template(template_name: str, **kwargs) -> str:
    """Translate template placeholders"""
    # This would be used in templates to translate dynamic content
