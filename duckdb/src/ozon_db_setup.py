...
def populate_database(database_name=None):
    """
    Populate the database with sample data.
    
    Args:
        database_name: Name of the database file to use (optional)
    """
    import os
    import duckdb
    import json
    ...
    # Configuration
    db_name = database_name or os.getenv('DUCKDB_DATABASE_NAME', 'ozon_products.duckdb')
    debug_mode = os.getenv('DEBUG_MODE', 'False').lower() == 'true'
    ...
    # Close connection
    con.close()
    print(f"💾 База сохранена в '{db_name}'")
    if debug_mode:
        print("🔧 Режим отладки включен")
