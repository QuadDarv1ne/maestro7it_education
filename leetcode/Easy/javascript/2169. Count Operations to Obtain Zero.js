 ...
 *
 * @param {number} num1 - Первое неотрицательное целое число.
 * @param {number} num2 - Второе неотрицательное целое число.
 * @returns {number} Количество операций, необходимых для того, чтобы сделать либо num1, либо num2 равным нулю.
 */
class Solution {
