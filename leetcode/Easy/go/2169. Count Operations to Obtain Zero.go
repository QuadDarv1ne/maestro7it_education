...
//
// Parameters:
// num1: Первое неотрицательное целое число.
// num2: Второе неотрицательное целое число.
//
// Returns:
// int: Количество операций, необходимых для того, чтобы сделать либо num1, либо num2 равным нулю.
