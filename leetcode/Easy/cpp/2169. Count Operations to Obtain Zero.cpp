...
/**
 * @brief Подсчитывает количество операций, необходимых для получения нуля из двух неотрицательных целых чисел.
 ...
 * @return int Количество операций, необходимых для того, чтобы сделать либо num1, либо num2 равным нулю.
 */
class Solution {
public:
