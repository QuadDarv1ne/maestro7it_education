...
class Solution:
    ...
    Подход:
    1. Уменьшаем columnNumber на 1 (чтобы 1 -> A, а не 0 -> A)
    2. Берем остаток от деления на 26 и преобразуем в букву
    3. Делим на 26 и повторяем
    ...
    def convertToTitle(self, columnNumber):
        ...
        # Переворачиваем, так как строили справа налево
