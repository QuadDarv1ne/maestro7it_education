...
class Solution {
     ...
     * - Память: O(1) для сортировки на месте в случае примитивного массива
     * 
     * @param nums Массив целых чисел (оценки учащихся)
     * @param k Количество элементов для выбора в группе
     * @return Минимальную возможную разницу между максимальным и минимальным 
