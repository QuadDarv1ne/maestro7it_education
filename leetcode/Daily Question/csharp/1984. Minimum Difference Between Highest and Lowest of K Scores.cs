...
public class Solution {
    ...
    /// - Память: O(1) для сортировки на месте в случае int[]
    /// 
    /// Параметры:
    ///   nums - Массив целых чисел (оценки учащихся)
    ///   k - Количество элементов для выбора в группе
    /// 
    /// Возвращает:
    ///   Минимальную возможную разницу между максимальным и минимальным 
