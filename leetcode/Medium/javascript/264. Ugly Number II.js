 ...
 * ограничены 2, 3 и 5. Последовательность: 1, 2, 3, 4, 5, 6, 8, 9, 10, 12...
 *
 * @param {number} n - Порядковый номер уродливого числа (1-индексировано)
 * @return {number} n-е уродливое число
 *
 * @example
 * // Возвращает 12
 * nthUglyNumber(10)
