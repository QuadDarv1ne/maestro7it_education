...
public:
    vector<int> getBiggestThree(vector<vector<int>>& grid) {
        ...
        set<int> sums; // Используем set для автоматической сортировки и уникальности
        ...
        for (int i = 0; i < m; ++i) {
            for (int j = 0; j < n; ++j) {
                ...
                int maxK = min({i, m - 1 - i, j, n - 1 - j}) + 1;
        ...
        // Преобразуем set в вектор в обратном порядке (убывание)
